...
const AgentsSvg = <i className="ri-group-line  side-menu__icon"></i>

const SettingsSvg = <i className="ti ti-settings  side-menu__icon"></i>

const NoticeSvg = <i className="ti ti-notification  side-menu__icon"></i>

const AdminsSvg = <i className="ri-user-line  side-menu__icon"></i>

const Dashboardsvg = <i className="ri-home-8-line side-menu__icon"></i>

const OrderSvg = <i className="ti ti-ad-2  side-menu__icon"></i>

const LogfileSvg = <i className="ti ti-writing side-menu__icon"></i>

const UserChatSvg = <i className="ti ti-brand-hipchat side-menu__icon"></i>

const AdminChatSvg = <i className="ti ti-message-language side-menu__icon"></i>
...
export const MenuItems = [
	{
		Items: [
			...
			{
				id: 3,
				path: `${ import.meta.env.BASE_URL }adminList`,
				type: "link",
				active: false,
				selected: false,
				title: "Admin List",
			...
			{
				id: 4,
				path: `${ import.meta.env.BASE_URL }userList`,
				type: "link",
				active: false,
				selected: false,
				title: "User List",
			...
			{
				id: 5,
				path: `${ import.meta.env.BASE_URL }orderHistory`,
				type: "link",
				active: false,
				selected: false,
				title: "Order History",
			...
			{
				id: 6,
				path: `${ import.meta.env.BASE_URL }settingsnav`,
				type: "link",
				active: false,
				selected: false,
				title: "Settings",
			...
			// {
				// 	id: 7,
			// 	path: `${ import.meta.env.BASE_URL }userChat`,
			// 	type: "link",
			// 	active: false,
			// 	selected: false,
			// 	title: "User Chat",
			...
			// {
			// 	id: 7,
			// 	path: `${ import.meta.env.BASE_URL }adminChat`,
			// 	type: "link",
			// 	active: false,
			// 	selected: false,
			// 	title: "Admin Chat",
			...
			{
				id: 8,
				path: `${ import.meta.env.BASE_URL }noticenav`,
				type: "link",
				active: false,
				selected: false,
				title: "Notification",
			...
			{
				id: 9,
				path: `${ import.meta.env.BASE_URL }adminLogfile`,
				type: "link",
				active: false,
				selected: false,
				title: "Log File",
