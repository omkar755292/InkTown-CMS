...
import inkTownDesktop from '../../../assets/img/inktown-desktop.png';
...
const Sidebar = ( { local_varaiable, ThemeChanger } ) =>
{
    ...
    if ( menuitems )
    {
      menuitems.filter( mainlevel =>
      {
        if ( mainlevel.Items )
        {
          ...
          {
            if (
              ulRef.current.href != location.href ||
              localStorage.Syntoverticalstyles != 'doublemenu'
            )
            {
              items.active = false
            }
  ...
  {
    if (
      localStorage.Syntoverticalstyles != 'overlay' &&
      localStorage.Syntoverticalstyles != 'detached'
    )
    {
      setSidemenu()
    }
                ...
                <React.Fragment key={ Math.random() }>
                  { firstlayer.menutitle ? (
                    ...
                    >
                      ...
                      >
                        { firstlayer.menutitle2 }
                      </div>
                      <div
                        style={ { marginBottom: '0.5rem', marginLeft: '2.0rem' } }
                      >
                        { firstlayer.menutitle3 }
                      </div>
                    </li>
                  ) : (
                    ''
                  ...
                  { firstlayer.Items.map( secondlayer =>
                    secondlayer.type === 'link' ? (
                      ...
                      <li
                        className={ `slide has-sub ${ secondlayer.active ? 'open' : ''
                          }` }
                        key={ Math.random() }
                        onClick={ () =>
                        {
                      ...
                      >
                        ...
                        <ul
                          className={ `slide-menu child1 ${ secondlayer.active ? '!block' : ''
                            }` }
                        >
                          ...
                          { secondlayer.children.map( thirdlayer => (
                            <React.Fragment key={ Math.random() }>
                              { thirdlayer.type === 'link' ? (
                                <li
                                  className={ `slide ${ thirdlayer.active ? 'active' : ''
                                    }` }
                                >
                                  { thirdlayer.path == '/' ? (
                                    <Link
                                ...
                                >
                                  ...
                                  <ul
                                    className={ `slide-menu child2 ${ thirdlayer.active ? '!block' : ''
                                      }` }
                                  >
                                    { thirdlayer.children.map( fourthlayer => (
                                      <React.Fragment key={ Math.random() }>
                                        { fourthlayer.type === 'link' ? (
                                          <li
                                            className={ `slide ${ fourthlayer.active ? 'active' : ''
                                              }` }
                                          >
                                            <Link
                                              onClick={ event =>
                                              ...
                                              className={ `side-menu__item ${ fourthlayer.selected
                                                ? 'active'
                                                : ''
                                                }` }
                                            >
                                          ...
                                          <li
                                            className={ `slide has-sub ${ fourthlayer.active ? 'open' : ''
                                              }` }
                                          >
                                            <a
                                              href='#'
                                            ...
                                            <ul
                                              className={ `slide-menu child3 ${ fourthlayer.active
                                                ? '!block'
                                                : ''
                                                }` }
                                            >
